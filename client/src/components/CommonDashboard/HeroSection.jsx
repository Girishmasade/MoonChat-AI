...
export default function HeroSection() {
  return (
    <section className="mx-auto px-4 sm:px-6 lg:px-16 pt-32 md:py-44 max-w-7xl min-h-screen">
      <div className="grid items-center gap-10 md:grid-cols-2">
        ...
        <div className="space-y-6">
          ...
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold tracking-tight leading-tight">
            ...
            <span className="font-bold p-1 m-1 rounded-lg pt-0 px-3 text-violet-900 animate-blink">
              AI
            </span>{" "}
            Real-Time System
          </h1>

          <p className="text-base sm:text-lg text-muted-foreground dark:text-gray-300 text-gray-800 max-w-xl">
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            <Link
              to={"/signup"}
              className="w-full sm:w-auto text-md font-semibold border p-3 rounded-lg bg-[#873ee0] border-black btn hover:bg-[#9641ff]"
            >
              Get Started
            </Link>
          </div>
          ...
          <div className="flex gap-4 text-muted-foreground items-center text-sm">
            ...
            <span className="dark:text-gray-300 text-gray-800">Trusted by teams worldwide</span>
          </div>
        </div>
        ...
        <div className="relative w-full flex justify-center md:justify-end">
          ...
          <div
            className="hidden md:block absolute -right-20 top-10 w-56 h-56 rounded-full bg-[#9254de] blur-3xl opacity-70 pointer-events-none"
            aria-hidden
          />
          <div
            className="block md:hidden absolute -top-10 left-1/2 transform -translate-x-1/2 w-40 h-40 rounded-full bg-[#9254de] blur-3xl opacity-60 pointer-events-none"
            aria-hidden
          />
          ...
          <div className="relative rounded-2xl border bg-card shadow-xl overflow-hidden w-full max-w-xl">
            <div className="flex items-center gap-2 border-b px-4 py-3">
              ...
              <span className="ml-2 text-sm font-medium text-muted-foreground text-gray-400">
                Team Chat
              </span>
            </div>
            ...
            <div className="p-4 space-y-3 bg-gradient-to-b from-background to-muted/40">
              <div className="flex flex-col space-y-3 max-h-80 pr-2">
                <div className="flex justify-start">
                  <div className="bg-[#9254de] text-foreground max-w-[85%] sm:max-w-[75%] rounded-2xl px-4 py-2 text-sm shadow-sm">
                ...
                <div className="flex justify-end">
                  <div className="bg-[#6b21a8] text-foreground max-w-[85%] sm:max-w-[75%] rounded-2xl px-4 py-2 text-sm shadow-sm">
