...
import { addContact, AiMessage, getAiMessages, getAllContacts, getAllMessages, removeContact, sendMessage } from "../controllers/chats.controller.js";
...
chatRouter.post("/send-ai-messages/:receiverId", protectedRoute, uploadMedia.any(), AiMessage)
chatRouter.get("/get-ai-messages/:recieverId", protectedRoute, getAiMessages)
